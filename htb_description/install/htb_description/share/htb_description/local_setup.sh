...
: ${AMENT_CURRENT_PREFIX:="/mnt/DatosLinux/repositorios/hover-table-bot-HTB/htb_description/install/htb_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/htb_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/htb_description/environment/path.sh"
